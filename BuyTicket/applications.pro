...
-keepclassmembers class com.buyticket.core.HttpService12306$SubmitTokenInfo{*;}
-keepclassmembers class com.buyticket.core.Cfg{*;}
-keepclassmembers class com.buyticket.core.ChaoJiYing{*;}
