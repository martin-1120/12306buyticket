...
public class DateTimePicker extends JPanel
{
	 ...
	 */
        ...
        public DateTimePicker(Container owner,int length) {
           this.owner = owner;
        ...
        public DateTimePicker(Container owner, String partten,int length) {
            this.owner = owner;
            this.parten = partten;
            this.length=length;
            try {
        ...
        public DateTimePicker(Container owner, String partten) {
            this.owner = owner;
            this.parten = partten;
            try {
                init();
        ...
        public DateTimePicker(Container owner) {
            this.owner = owner;
            this.parten = "yyyy-MM-dd";
            try {
                init();
        ...
        private void init() throws Exception {
            ...
            dateField.addMouseListener(new MouseAdapter() {
            	...
            	public void mouseClicked(MouseEvent e) {
            		btnChoose_actionPerformed(null);
            	}
			});
            ...
            btnChoose.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                	DateTimePicker.this.btnChoose_actionPerformed(e);
                }
            });
            Date date = new Date();
        ...
        public void setText(String text) {
        	...
        	try {
				calendar.setTime(sdf.parse(dateField.getText()));
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 1) {
                    ...
                    SimpleDateFormat simpleDateFormat = new SimpleDateFormat(
                        pattern);
                    DateTimePicker.this.setText(simpleDateFormat.format(selectDate));
